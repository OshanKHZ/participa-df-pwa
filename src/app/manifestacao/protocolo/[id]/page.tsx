      ...
      <div className="lg:hidden min-h-screen bg-background">
        ...
        <main id="main-content" className="px-4 py-8">
          ...
          <div className="bg-card rounded-lg p-6 card-border mb-6">
            <div className="text-center mb-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleCopy}
                  className={`flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md font-medium transition-all btn-focus ${
                    copied
                ...
                <button
                  onClick={handlePrint}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md font-medium transition-all btn-focus bg-accent text-accent-foreground hover:bg-accent/80"
              ...
              <Link
                href="/historico"
                className="w-full bg-accent hover:bg-accent/80 text-secondary font-medium py-2 px-4 text-sm flex items-center justify-center gap-2 btn-focus rounded-md mt-3 transition-colors"
              >
          ...
          <div className="space-y-3">
            <Link
              href="/"
              className="block w-full bg-secondary hover:bg-secondary-hover text-secondary-foreground font-medium py-3 px-6 rounded-md text-center btn-focus"
            >
        ...
        <main id="main-content" className="max-w-2xl mx-auto px-8 py-12">
          ...
          <div className="bg-card rounded-xl p-8 card-border mb-8 shadow-lg">
            <div className="text-center mb-6">
              ...
              <div className="flex justify-center gap-3">
                <button
                  onClick={handleCopy}
                  className={`inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all btn-focus ${
                    copied
                      ? 'bg-[var(--color-progress)] text-white'
                      : 'bg-accent text-accent-foreground hover:bg-accent/80'
                  }`}
                ...
                <button
                  onClick={handlePrint}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all btn-focus bg-accent text-accent-foreground hover:bg-accent/80"
                  aria-label="Imprimir protocolo"
                >
              ...
              <Link
                href="/historico"
                className="inline-flex items-center justify-center gap-2 bg-accent hover:bg-accent/80 text-secondary font-medium py-2 px-4 text-sm btn-focus rounded-lg mt-3 transition-colors"
              >
                <RiSearchLine className="size-4" aria-hidden="true" />
                Consultar protocolo
              </Link>
          ...
          <div className="space-y-3">
            <div className="flex justify-center">
              <Link
                href="/"
                className="inline-flex items-center gap-2 bg-secondary hover:bg-secondary-hover text-secondary-foreground font-medium py-3 px-8 rounded-lg btn-focus"
              >
                <RiHomeLine className="size-5" aria-hidden="true" />
                Voltar ao início
              </Link>
